...
function PermanentAddressSection({ employeeId }) {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/api/employees/${employeeId}/permanent-address`)
      .then((res) => {
  ...
  const handleSave = (e) => {
    ...
    axios
      .post(`http://localhost:8080/api/employees/${employeeId}/permanent-address`, form)
      .then(() => alert("Permanent Address Saved"))
      .catch(() => alert("Failed to save permanent address"));
  };
